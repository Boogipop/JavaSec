...
public final class StreamMessageImpl extends MessageImpl implements StreamMessage, Externalizable {
    ...
    public StreamMessageImpl(StreamMessage var1) throws Exception {
        this(var1, (Destination) null, (Destination) null);
    }

    public StreamMessageImpl(StreamMessage var1, Destination var2, Destination var3) throws Exception, JMSException {
    ...
    private byte readType() throws Exception {
    ...
    private void writeType(byte var1) throws javax.jms.JMSException {
        this.checkWritable();
    ...
    public boolean readBoolean() throws JMSException, MessageEOFException {
        byte var1 = 0;
        try {
            var1 = this.readType();
        } catch (Exception e) {
    ...
    public byte readByte() throws JMSException, MessageEOFException {
        byte var1 = 0;
        try {
            var1 = this.readType();
        } catch (Exception e) {
    ...
    public short readShort() throws JMSException, MessageEOFException {
        byte var1 = 0;
        try {
            var1 = this.readType();
        } catch (Exception e) {
    ...
    public char readChar() throws JMSException, MessageEOFException {
        byte var1 = 0;
        try {
            var1 = this.readType();
        } catch (Exception e) {
    ...
    public int readInt() throws JMSException, MessageEOFException {
        byte var1 = 0;
        try {
            var1 = this.readType();
        } catch (Exception e) {
    ...
    public long readLong() throws JMSException, MessageEOFException {
        byte var1 = 0;
        try {
            var1 = this.readType();
        } catch (Exception e) {
    ...
    public float readFloat() throws JMSException, MessageEOFException {
        byte var1 = 0;
        try {
            var1 = this.readType();
        } catch (Exception e) {
    ...
    public double readDouble() throws JMSException, MessageEOFException {
        byte var1 = 0;
        try {
            var1 = this.readType();
        } catch (Exception e) {
    ...
    public String readString() throws JMSException, MessageEOFException {
        byte var1 = 0;
        try {
            var1 = this.readType();
        } catch (Exception e) {
    ...
    public int readBytes(byte[] var1) throws JMSException, MessageEOFException {
        boolean var3 = true;
        if (var1 == null) {
            throw new NullPointerException();
        } else {
    ...
    public Object readObject() throws JMSException, MessageEOFException {
        byte var1 = 0;
        try {
            var1 = this.readType();
        } catch (Exception e) {
    ...
    public void writeString(String var1) throws javax.jms.JMSException {
        if (var1 == null) {
    ...
    private void checkReadable() throws Exception {
        super.readMode();
...
//        }
        ...
        if (var3 >= 1 && var3 <= 3) {
            switch (var3) {
                case 1:
                    ...
                    } catch (MessageFormatException var11) {
    ...
    private void writeStringInternal(String var1) throws IOException, javax.jms.JMSException {
